    ...
    "Statement": [
        {
            "Effect": "Allow",
            "Principal": {
                "Federated": "arn:aws:iam::319602347522:oidc-provider/token.actions.githubusercontent.com"
            },
            ...
            "Condition": {
                ...
                "StringLike": {
                    "token.actions.githubusercontent.com:sub": "repo:chimdi247*/food-delivery-devsecops-project-github-actions-DAST-EKS*:*"
                }
            }
        }
    ]
...
#### Step 15.2: Login to Admin Panel

**The admin account is created automatically during deployment.** No manual steps needed.
...
1. Go to **Admin Panel** (`admin.your-domain.com`)
2. Login with the credentials above
3. Go to **Add Items** → Add more food items if needed
4. Go to **Orders** → Manage customer orders
